...
public class TestJumpEqualFunction {
    public static void main(String[] args) {
        System.out.println("Starting TestJumpEqualFunction...");
        try {
            SProgramImpl program = new SProgramImpl("TestJumpEqualFunction");
            Path xmlPath = Path.of("C:\\Users\\user\\IdeaProjects\\S-emulator\\test_jump_equal_function.xml");
