...
public class TestMinimalAssignment {
    public static void main(String[] args) {
        try {
            // Create a minimal program with just an assignment
            SProgram program = new SProgramImpl("Minimal");
            
            // Add a simple assignment: y <- x1
            program.addInstruction(new AssignVariableInstruction(Variable.RESULT, Variable.of("x1")));
            
            System.out.println("=== Minimal Assignment Test ===");
